...
import com.example.entries.Controller.UpdateListAsyncTask
...
class MainActivity : AppCompatActivity(), UpdateListAsyncTask.CommunicateThread {
    private val sharedPrefOperations = SharedPrefOperations(this)
    lateinit var adapter: RecyclerViewAdapter
    private lateinit var fileStorage: FileStorage

    override fun getBookList(bookList: MutableList<Book>) {
...
//        recycler_view.adapter = adapter
    ...
    private fun setupRecyclerView(list: MutableList<Book>){
        recycler_view.setHasFixedSize(true)
        val manager = LinearLayoutManager(this, RecyclerView.VERTICAL, false)
